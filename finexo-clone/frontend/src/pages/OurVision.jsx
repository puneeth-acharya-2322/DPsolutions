                    ...
                    <div className="footer-content-wrapper">
                        <div data-w-id="19cac388-8877-fdb5-ab95-2fa6ded75ac7"
                            ...
                            <p className="footer-description">
                                We're looking for brands and partners who believe in structured, sustainable growth. Let's build something lasting together.
                            </p>
                        ...
                        <div data-w-id="19cac388-8877-fdb5-ab95-2fa6ded75ad3"
                            ...
                            <h2>Let's connect</h2>
                            <p className="footer-description">
                                Whether you're an emerging brand or an established business, we're ready to help you scale with clarity.
                            </p>
